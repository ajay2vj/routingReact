            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="product-image" data-aos="fade-up" data-aos-delay="500">
                  <img src={window.location.origin + '/images/product-1.webp'} width="100%" alt="shoe"/>
              ...
              <div className="col-md-4">
                <div className="product-image" data-aos="fade-up" data-aos-delay="500">
                  <img src={window.location.origin + '/images/product-2.webp'} width="100%" alt="shoe"/>
                  <div className="card-body">
                    <p>desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum</p>
                  </div>
                </div>
              ...
              <div className="col-md-4">
                <div className="product-image" data-aos="fade-up" data-aos-delay="500">
                  <img src={window.location.origin + '/images/product-3.webp'} width="100%" alt="shoe"/>
                  <div className="card-body">
                    <p>desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum</p>
                  </div>
                </div>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="left-side-column" data-aos="fade-up" data-aos-delay="500">
                  <img src={window.location.origin + '/images/about.jpeg'} width="100%" alt="shoe"/>
                </div>
              </div>
              <div className="col-md-6">
                <div className="right-side-column" data-aos="fade-up" data-aos-delay="500">
                  <p><img src={window.location.origin + '/images/icon.png'} alt="shoe"/></p>
